...
class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.title.push(this.add.bitmapText(this.worldWidth / 2 - 320, 100, "game-font", "ROADWARR.IO", 60));
        this.text.push(this.add.bitmapText(this.worldWidth / 2 - 150, this.worldHeight / 2, "game-font", "ENTER: Start game", 20));
    }
    update() {
